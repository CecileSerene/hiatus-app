...
public class ContributionFragmentArrayAdapter extends ArrayAdapter<ContributionContext> {

    public ContributionFragmentArrayAdapter(Context context, ArrayList<ContributionContext> contexts) {
