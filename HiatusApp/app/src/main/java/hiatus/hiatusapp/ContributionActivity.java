...
public class ContributionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        issue.setParticipative(new CurrentIssue.Participative( "texte", 20.0, "sur le vif"));
        ...
        String type = issue.getParticipative().getType();
        ...
        explanation.setText("La contribution est sur le thème " + theme + "." +
                " Il s'agit de faire un " + type + " en suivant les instructions suivantes : " + instruction + "." +
